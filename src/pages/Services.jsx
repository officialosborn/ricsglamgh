...
export default function Services() {
  ...
  // Scroll to booking when navigated from another page or via hash
  useEffect(() => {
      ...
      <div className="services-header">
        <div className="container">
          ...
          <p className="services-intro">
            Professional beauty services tailored to bring out your best. Visit us in Accra, Ghana.
          </p>
        </div>
      </div>
        ...
        <div className="container">
          {services.length === 0 ? (
            <div className="services-empty">
              <p>Services coming soon. Contact us via WhatsApp for bookings.</p>
            </div>
          ) : (
          ...
          <div className="booking-grid">
            ...
            <form className="booking-form" onSubmit={handleSubmit}>
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  <label>Preferred Time <span className="optional">(optional)</span></label>
                  <input
                    name="time"
                    type="time"
                    value={form.time}
